        ...
        <Row>
            ...
            <Col className="col mb-5" xs="12" sm="12" md="6" style={{display: 'flex'}}>
                <div className="align-middle">
                    ...
                    <p>
                        We build all of our images on our own <a href="https://ci.linuxserver.io" target="_blank">pipeline</a> and then upload them directly to <a href="https://hub.docker.com/u/linuxserver/" target="_blank">Docker Hub</a>. The list of our images is ever expanding as we get new requests from our users. We provide images for the <code>x86</code>, <code>armhf</code> and <code>arm64</code> architectures.
                    </p>
                </div>
            </Col>
        </Row>
